...
Route::get('/space-create/bedrooms/edit-bedroom','CreateSpaceController@Second2');
Route::get('/space-create/bedrooms/edit-bedroom/add-bed','CreateSpaceController@Second3');
