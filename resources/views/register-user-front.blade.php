                ...
                <div class="intro-message1">                     
                    ...
                    <form class="form-horizontal">
                        <div class="form-group separation-element-form">
                            <label for="name" class="col-sm-offset-3 col-sm-2  control-label" style="text-align:left; color:#023859">Name</label>
                            <div class="col-sm-4">
                                  <input type="text" class="form-control" id="name" placeholder="Name">
                            </div>
                        </div>
                        <div class="form-group separation-element-form">
                            <label for="email" class="col-sm-offset-3 col-sm-2  control-label" style="text-align:left; color:#023859">Email</label>
                            <div class="col-sm-4">
                                  <input type="email" class="form-control" id="email" placeholder="Email">
                            </div>
                        </div>
                        <div class="form-group separation-element-form">
                            <label for="password" class="col-sm-offset-3 col-sm-2 control-label" style="text-align:left; color:#023859">Password</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-4 separation">
                                <div class="checkbox">
                                    <label>
                                      <input type="checkbox"> <span class="colortext">I agree with terms and conditions, privacy politics, guest refund politics and payments terms o service</span>
                                    </label>
                                </div>
                            </div>
                        </div>
