        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
            <div class="row">
                <div class="col-lg-8 col-md-9 col-lg-offset-2 col-md-offset-1">
                    ...
                    <form id="formNextToBathrooms" method="POST" action="{{ url('/create-workspace/baths/show-bathroom') }}">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right">
            <div class="RetNex">
                <br>
                <a href="{{ url('/create-workspace/baths') }}"><strong>NEXT</strong><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
            </div>
        </div>
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
    </div>
