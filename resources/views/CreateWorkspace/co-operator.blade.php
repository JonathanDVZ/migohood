@extends('layouts.master') @section('title', 'Co-Operator') @section('class', 'contenedor') @section( 'content')@include('CreateWorkspace.navbar.navbar',['activo' => 'co-operator'])
    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 col-lg-offset-1 col-md-offset-1 col-sm-offset1 col-xs-offset-1 text-left">
            ...
            <div class="tex-left RetNex">
                <a href="{{url('/create-workspace/notes')}}"><i class="fa fa-chevron-left" aria-hidden="true"> </i><strong>BACK</strong></a>
            </div>
        </div>
