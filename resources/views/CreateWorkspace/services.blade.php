...
<div class="container">
    ...
    <form id="formAddServices" method="POST" action="{{url('/create-workspace/save-services')}}" enctype="multipart/form-data">
        <div class="row">
    ...
    </form><form id="formAddServices" method="POST" action="{{url('/create-space/save-services')}}" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 col-lg-offset-1 col-md-offset-1 col-sm-offset1 col-xs-offset-1 text-left">
                ...
                <div class="tex-left RetNex">
                    <a href="{{url('/create-workspace/photos')}}"><i class="fa fa-chevron-left" aria-hidden="true"> </i><strong>BACK</strong></a>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right">
                <div class="RetNex">
                    <br>
                    <a href="{{url('/create-workspace/notes')}}"><strong>NEXT</strong><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </div>
            </div>
