<div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 nopadding-right">
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                @if(isset($img) AND !empty($img) AND $img != 'imagen not found' AND $img !='Service not found')
                <div class="carousel-inner">
                    <div class="item active">
                        <img class="img-responsive img-carousel" src="{{asset($img[0]['ruta'])}}" alt="Slide 1"  />
                    </div>
                    @foreach(array_slice($img,1) as $img)
                    <div class="item">
                        <img class="img-responsive img-carousel" align="center" src="{{asset($img['ruta'])}}" alt="$img['description']"  />
                    </div>
                    @endforeach
                </div>
