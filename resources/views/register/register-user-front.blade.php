                ...
                <div class="intro-message1">                     
                    ...
                    <form class="form-horizontal">
                        <div class="form-group separation-element-form">
                            <label for="name" class="col-sm-offset-4 col-sm-2  control-label" style="text-align:left; color:#023859">Name</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group separation-element-form">
                            <label for="confirmpassword" class="col-sm-offset-4 col-sm-2 control-label" style="text-align:left; color:#023859">Confirm Password</label>
                            <div class="col-sm-3">
